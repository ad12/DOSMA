...
class TestFormatIOUtils(unittest.TestCase):
    ...
    def test_convert_image_data_format(self):
        ...
        assert fio_utils.convert_image_data_format(dcm_dir, ImageDataFormat.nifti) == f"{dcm_dir}.nii.gz"

        assert fio_utils.convert_image_data_format(dcm_fname, ImageDataFormat.dicom) == dcm_fname
        # assert fio_utils.convert_image_data_format(dcm_fname, ImageDataFormat.nifti) == nifti_fname

        assert fio_utils.convert_image_data_format(nifti_fname, ImageDataFormat.nifti) == nifti_fname
